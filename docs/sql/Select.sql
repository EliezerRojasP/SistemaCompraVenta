...
select * from TD_COMPRA_DETALLE WHERE COMPR_ID = 21


ALTER PROCEDURE SP_U_COMPRA_02
@COMPR_ID INT
AS
BEGIN
SET NOCOUNT ON
	...
	DECLARE CUR CURSOR FOR SELECT DETC_ID FROM TD_COMPRA_DETALLE WHERE COMPR_ID = 21
	OPEN CUR 
